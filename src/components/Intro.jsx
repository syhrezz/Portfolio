...
const Intro = () => {
  return (
    <div className="mt-24 bg-white relative overflow-hidden flex flex-col items-center" id='Intro'>
      ...
      <img className="-mt-28 h-2/3 object-cover" src={profileImage} alt="Intro Image" />
      
      <div className="hidden lg:block absolute bottom-0 right-0 left-0 mx-auto w-80 h-80 bg-indigo-900 rounded-full -z-10"></div>
      ...
      <div className="hidden lg:flex flex-col gap-1 rounded-md absolute -top-10 bottom-0 m-auto right-10 bg-white dark:bg-slate-900 dark:shadow-slate-800 p-6 h-fit w-1/3">
