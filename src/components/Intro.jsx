...
const Intro = () => {
  ...
  return (
    <div className="relative flex flex-col items-center bg-white overflow-hidden" id='intro'>
      ...
      className="relative overflow-hidden group bg-white text-orange-500 font-base py-2 px-6 rounded-md border border-orange-500 shadow-sm hover:shadow-md transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
