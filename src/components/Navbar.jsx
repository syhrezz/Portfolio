...
const Navbar = () => {
  return (
    <body className="bg-orange-500 font-poppins items-center justify-center">
      <nav className="fixed top-28 left-8 w-16 py-24 bg-white bg-opacity-80 flex flex-col items-center z-50 rounded-xl shadow-xl" style={{ backgroundColor: 'rgba(255, 255, 255, 0.3)', backdropFilter: 'blur(10px)' }}>
        {/* Add logo or brand icon here */}

        <ul className="flex flex-col items-center flex-grow justify-center space-y-6">
          <li>
            <a className="hover:text-orange-500" href="#" title="Intro">
